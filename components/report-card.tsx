...
export function ReportCard({ report, onStatusChange }: ReportCardProps) {
  ...
  return (
    <div className="group bg-card rounded-2xl overflow-hidden border border-border hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
      {/* Large Image */}
      ...
      <div className="p-4 space-y-3">
        ...
        <a
          ...
          className="flex items-start gap-2 p-3 bg-accent/40 hover:bg-accent/60 rounded-xl transition-colors group/location"
        >
